...
import type { CompanyRoleListItem } from "@/src/framework/graphql/queries/companyRoles";
...
type Props = {
  ...
  /** Build the edit URL for a given role id (page passes the route prefix). */
...
function CompanyRolesTableComponent({
  rows,
  busyRoleId,
  onDuplicate,
  onDelete,
...
/** Magento ships role ids as base64 UIDs in the storefront; decode to the
 *  raw integer for the admin-matching "ID" column. */
...
export const CompanyRolesTable = memo(CompanyRolesTableComponent);
CompanyRolesTable.displayName = "CompanyRolesTable";
