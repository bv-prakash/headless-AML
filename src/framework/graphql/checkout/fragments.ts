/**
 * Shared GraphQL fragments for checkout (cart address shapes, shipping
 * rates, payment methods). Compose these in mutations/queries so field
 * lists stay DRY and stay in sync.
 */

/** Postal + region/country block for any `CartAddressInterface`
 *  (shipping or billing on the quote). */
