...
/**
 * Dedicated stores query runner so query + response contract stay co-located.
 * Caller passes endpoint (`/api/graphql-proxy` on client or Magento GraphQL on server).
 */
